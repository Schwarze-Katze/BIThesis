...
访问 \url{https://bithesis.bitnp.net}，点击右上角的 ``模板下载'' ，跳转到 BITHesis 项目的 GitHub Releases 页面。选择相应的模板压缩包并下载。
...
\section{在 Overleaf（浏览器）上编译生成 PDF}
...
选择自己需要的模板，点击 ``Open in Overleaf'' 按钮，即可跳转到 Overleaf 上分享的项目中。
